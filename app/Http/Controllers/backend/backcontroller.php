...
//____________about_______________________//
 ...
 //________Term& Condition__________//
...
//______user data update________//
	public function Customer_updatemethod(Request $id,$req){
		...
		if(isset($new_image))
		{
			...
			Image::make($new_image)->save('image/adminimage/'.$image_one_name,80);
