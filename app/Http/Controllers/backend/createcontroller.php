 ...
 public function insertadminmethod(Request $r){
	...
	$user_type ='1';
  	...
  	$newimage   = $r->file('image');
		if ($newimage){
			...
			Image::make($newimage)->save('image/adminimage/'.$image_name,80);
			$data['image']='image/adminimage/'.$image_name;
   ...
   $user_type='1';
		...
		if (isset($newimage))
		{
			...
			Image::make($newimage)->save('image/adminimage/'.$image_one_name,80);
