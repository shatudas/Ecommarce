...
class fontcontroller extends Controller
{
  ...
  //--------------slider show--------//
		...
		return view('frontend.layouts.home',compact('showbycategory','brandinfo','slideractive','slidermore','itemname'));
	}
...
//=============FAQ controller=======//
	public function FAQ_pagemethod(){
		...
		return view('frontend.pages.faq_page',compact('FAQdata'));
	}
...
//=======brand all controller===========/
	public function bradmethod($id)
	{
		...
		return view('frontend.product_info.brand_to_product',compact('brandPro','brand','nameshow'));
	}
...
//==========item to product controller========//
	public function itemPormethod($id){
		...
		return view('frontend.product_info.item_To_pro',compact('itemName','catName','itempro'));
	}
...
//=========category to product controller========//
	public function catPormethod($id){
		...
		->first();
		return view('frontend.product_info.cat_To_pro',compact('product_data','SubcatName','catname'));
	}
...
//=========sub category to product controller========//
	public function SubcatPromethod($id){
		...
		->first();
		return view('frontend.product_info.subcat_to_pro',compact('subcatpro','catname'));
	}
...
//========single Product view controller========//
	public function viewpromethod($id){
		...
		return view('frontend.product_info.view_product',compact('viewpro','setting','relatedproduct','productsize','productcolor'));
	}
...
//============search===========//
	public function searchmethod(Request $request){
		...
		->where('status', 1)->get();
		return view('frontend.product_info.searchdata',compact('product_cat'));
	}
...
//--------chackout page--------//
	public function chack_outmethod(){
		return view('frontend.product_info.chack_out');
	}


	public function cartmethod(){
		return view('frontend.product_info.cart');
	}
	...
	public function productmethod(){
		return view('frontend.product_info.product');
	}
 ...
 public function about_us_method(){
	...
	public function term_conditionmethod(){
		...
		return view('frontend.pages.term_condition',compact('term_condition'));
	}
	...
	public function how_tomethod(){
		...
		return view ('frontend.pages.how_to_bay', compact('how_to_data'));
	}
 ...
 public function blogsinglemethod(){
	...
	public function contactmethod(){
		...
		return view('frontend.pages.contact',compact('contenttable'));
	}
