				...
				<div class="col-xl-9 col-lg-9 col-md-8 col-sm-12 col-12 mt-4">
					<div class="row">
						<div class="col-md-1"></div>
							...
							<div class="col-md-10 p-4 userdashboard">
								<div class="row">
									<div class="col-md-1"></div>
									<div class="col-md-10">
										
								<strong>
									<i class="fa fa-user-circle-o" aria-hidden="true" style="color:#FF5500;"></i>
								  &nbsp;&nbsp;Edit Information
								</strong><br><br>
		                                     
								<form method="post" action="{{ route('userDataUpdate',Auth()->user()->id) }}" class="row passreset" id="btn-submit" >
									@csrf
