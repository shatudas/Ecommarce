...
<div class="col-md-12"   style="background-color:#F7F8FA; ">
	<div class="container-fluid padd py-4" >
     ...
     <div class="mt-4" id="menu">
      <li class="">
      	<a href="{{ route('userdashboard') }}"><i class="fa fa-tachometer" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Dashboard</a>
      </li>
      <li class="">
      	<a href="{{ route('all_order') }}"><i class="fa fa-list-ul" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Order Information</a>
      </li>
      <li class="">
      	<a href="{{ route('updateinformation') }}"><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Basic Information</a>
      </li>
      <li class=" active ">
      	<a href="{{ route('changepassword') }}"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Change Password</a>
      </li>
      <li>
      	<a href="{{ route('/')}}"><i class="fa fa-shopping-basket" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Go To Shopping</a>
      </li>
      <li>
        ...
        @csrf
			...
			<div class="col-xl-9 col-lg-9 col-md-8 col-sm-12 col-12 mt-4">
				...
				<div class="col-lg-8 p-4 userdashboard">
					...
					<strong>
						<i class="fa fa-key" aria-hidden="true" style="color:#FF5500;"></i>
					 &nbsp;&nbsp;Change Password</strong><br><br>

					<form  method="post" action="{{ route('userPassChange') }}" class="passreset mt-2" id="btn-submit">
						@csrf
