	...
	<div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel" style="padding:0px; margin:0px;">
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="carousel-item active">
				<div class="view">
					<a href="">
						<img class="d-block w-100" src="{{ asset($slideractive->slider_image) }}"
						alt="First slide">
					</a>
			...
			<div class="carousel-item">
				<div class="view">
					<img class="d-block w-100"  src="{{ asset($sliderinfo->slider_image) }}"
					alt="Second slide">
				...
				<div class="col-lg-2 col-md-4 col-sm-4 col-6 p-0" >
					<div class="col-sm-12 col-12 collections bg-white " style="border: 1px solid #F8F9FA;">
						<div class="bg-white grow py-1" style=" padding:0px; margin:0px;" >
							<center>
								<a href="{{ route('itemProduct',$catna->id) }}">
									<img src="{{ asset($catna->item_image) }}" class="img-fluid" style="max-height:120px; width:90%; margin-bottom:4px; margin-top:4px;"><br>
	...
	<div class="container-fluid" style="padding-top:8px;">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-12 text-md-right text-center subsearch mt-sm-0 mt-2" style=" padding-top:4px;">
				<a href="{{ route('itemProduct',$item_show->id) }}" class="viewproducts" style="margin-top:40px;">View All</a>
			</div>
		</div>
			...
			<div class="row" id="showproduct-130">
				...
				<div class="col-lg-2 cl-md-4 col-sm-6 col-6 mt-4">
					...
					<div class="homeproducts">
						<center>
							<a href="{{ route('product_view',$productShow->id) }}">
			...
			<div class="row" style="background:#f4f4f4">
				...
				<div class="p-2 col-lg-2 col-md-3 col-sm-4 col-6" style="background:#fff; border: 3px #f4f4f4  solid;align:center; ">
					<center style="padding:3px;">
						<a href="{{ route('brand',$brandname->id) }}">
							<img src="{{ asset($brandname->brand_image)  }}" class="img-fluid" alt="{{ asset($brandname->brand_name) }}" style="max-height:60px;">
						</a>
					</center>
					<center>
						<small style="text-transform:uppercase;">{{ $brandname->brand_name }}</small>
					</center>
				</div>
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6 char_col">
				<div class="char_item d-flex flex-row align-items-center justify-content-start">
					<div class="char_icon"><img src="{{ asset('fontlink')}}/images/char_1.png" alt=""></div>
			...
			<div class="col-lg-3 col-md-6 char_col">
				<div class="char_item d-flex flex-row align-items-center justify-content-start">
					<div class="char_icon"><img src="{{ asset('fontlink')}}/images/char_2.png" alt=""></div>
					<div class="char_content">
						<div class="char_title">Free Delivery</div>
						<div class="char_subtitle">from $50</div>
					</div>
			...
			<div class="col-lg-3 col-md-6 char_col">
				<div class="char_item d-flex flex-row align-items-center justify-content-start">
					<div class="char_icon"><img src="{{ asset('fontlink')}}/images/char_3.png" alt=""></div>
					<div class="char_content">
						<div class="char_title">Free Delivery</div>
						<div class="char_subtitle">from $50</div>
					</div>
			...
			<div class="col-lg-3 col-md-6 char_col">
				<div class="char_item d-flex flex-row align-items-center justify-content-start">
					<div class="char_icon"><img src="{{ asset('fontlink')}}/images/char_4.png" alt=""></div>
					<div class="char_content">
						<div class="char_title">Free Delivery</div>
						<div class="char_subtitle">from $50</div>
					</div>
