...
<div class="col-sm-12 col-12 pt-3 pb-3 bg-light">
		...
		<div class="row bg-white p-2 pt-4">
			...
			<div class="col-lg-4 col-md-12 col-sm-12 col-12">
				<section id="magnific">
					<div class="xzoom-container" style="border:1px solid #ccc; padding:5px;">
						<img class="xzoom5 img-fluid" id="xzoom-magnific" src="{{ asset($viewpro->product_image) }}" xoriginal="{{ asset($viewpro->product_image) }}"  style="width:100%;">
					</div>    
				</section>    
			</div>
			...
			<div class="col-lg-5 col-md-12 col-sm-12 col-12">
				<div class="col-sm-12 col-12 singledetails p-0">
					...
					<form method="post" action="{{ route('addtocart',$viewpro->id) }}">
						@csrf
			...
			<div class="col-lg-3 col-md-12 col-sm-12 col-12 bg-light p-4  text-dark border" style="font-size: 14px;">
				...
				<div>
					<div style="background-color:#fff;" align="center">
						<img src="{{ asset($setting->setting_image) }}" class="img-fluid" style="height:70px;margin-top:5px;">
						<br>
						<span>
					...
					<div class="viewed_slider_container">
						<div class="owl-carousel owl-theme viewed_slider">
							...
							<div class="owl-item grow" >
								...
								<a href="{{route('product_view',$relatedPro->id)}}">
									<div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center" >
										<div class="viewed_image" style="padding:0px; width:100%; height:auto;">
											<img src="{{ asset($relatedPro->product_image) }}" alt="" class="img-fluid" style="max-height:200px;  width:100%;">
										</div>
	...
	<script src="{{asset('fontlink')}}/product_view_link/setup.js"></script>
	<script type="text/javascript" src="{{asset('fontlink')}}/product_view_link/main.js"></script>
