	...
	<div class="container">
		...
		<div>
			<ul class="uk-breadcrumb" style="display: flex; flex-wrap: wrap;list-style: none;">
				...
				<li>
					<a href="#">
						<span style="color:gray">{{ $catname->item_name }}</span>
					</a>
				</li>
				&nbsp;&nbsp;&nbsp; 
				<i style="margin-top:3px;">|</i>
				&nbsp;&nbsp;&nbsp;
				<li>
					<span style="color:gray">{{ $catname->category_name }}</span>
				</li>
			</ul>
		</div>
			...
			<div class="col-lg-2 col-md-12 col-sm-12 col-12 p-0" style="border-radius:0px;">
				...
				<div class="list-group bg-dark " style="border-radius:0px;">
					...
					<div class="sidebarcat">
						...
						<a href="{{ route('SubcatProduct',$Subcat->id)}}" class="list-group-item list-group-item-action">{{ $Subcat->subcategory_name}}</a>
						@endforeach
					...
					<div class="row"  id="showdata">
						...
						<div class="col-lg-3 cl-md-4 col-sm-6 col-6 mt-4">
							...
							<div class="homeproducts border">
								<center>
									<a href="{{ route('product_view',$productview->id) }}">
										<img src="{{ asset($productview->product_image) }}" class="img-fluid" style=""></a>
								</center>
								<div>
