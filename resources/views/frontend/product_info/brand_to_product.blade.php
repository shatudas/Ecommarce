	...
	<div class="container-fluid">
		...
		<div>
			<ul class="uk-breadcrumb" style="display: flex; flex-wrap: wrap;list-style: none;">
				...
				<li>
					<span style="color:gray">{{ $nameshow->brand_name }}</span>
				</li>
			</ul>
		</div>
				...
				<div class="list-group bg-dark " style="border-radius:0px;">
					...
					<div class="sidebarcat">
						...
						@if(isset($brand))
							...
							<a href="{{ route('brand',$probrand->id) }}" class="list-group-item list-group-item-action
					...
					<div class="row"  id="showdata">
						...
						<div class="col-lg-3 cl-md-4 col-sm-6 col-6 mt-4">
							...
							<div class="homeproducts border">
								<center>
									<a href="{{ route('product_view',$brand_info->id) }}">
										<img src="{{ asset($brand_info->product_image) }}" class="img-fluid" style="">
									</a>
								</center>
								<div>
									<a href="{{ route('product_view',$brand_info->id) }}">
