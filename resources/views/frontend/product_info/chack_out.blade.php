	...
	<div class="container-fluid">
		<div>
			<ul class="uk-breadcrumb" style="display: flex; flex-wrap: wrap;list-style: none;">
				<li>
					<a href="{{ route('/') }}">Home</a>
				</li>&nbsp;&nbsp;&nbsp; <i style="margin-top:3px;">|</i> &nbsp;&nbsp;&nbsp;
				<li>
					<span style="color:gray">Chack Out</span>
				</li>
			</ul>
		</div>
	</div>
		...
		<div class="row" style="color: #585858;">
			<div class="col-lg-5 col-md-12 col-sm-12 col-12">
				...
				<div>
					...
					<form method="POST" action="{{ route('shiping_data',Auth()->user()->id) }}" style="background-color:">
						@csrf
										...
										<tbody id="placeordershow">
											...
											<tr class="text-center">
												...
												<td style="width:150px;">
													<form method="POST" action="{{ route('pro_update',$carddata->rowId) }}">
														@csrf
