...
<div class="col-md-12 pt-3 pb-2 bg-white" style="margin-top:30px;">
	<div class="container">
		...
		<div>
			<ul class="uk-breadcrumb" style="display: flex; flex-wrap: wrap; padding: 0;list-style: none;">
				<li>
					<a href="">Home</a></li>
					&nbsp;&nbsp;&nbsp;<i style="margin-top:3px;">|</i>&nbsp;&nbsp;&nbsp;
					<li>
						<a href=""><span style="color:gray;">{{ $catname->item_name }}</span></a></li>
						&nbsp;&nbsp;&nbsp;<i style="margin-top:3px;">|</i>&nbsp;&nbsp;&nbsp;
						<li>
							<a href=""><span style="color:gray;">{{ $catname->category_name }}</span></a></li>
							&nbsp;&nbsp;&nbsp;<i style="margin-top:3px;">|</i>&nbsp;&nbsp;&nbsp;
							<li>
								<span style="color:gray">{{ $catname->subcategory_name }}</span>
							</li>
						</ul>
					</div>
				</div>
						...
						<div class="col-lg-10 col-md-12 col-sm-12 col-12">
							<div class="col-sm-12 col-12 pa">
								<div class="row"  id="showdata">
									...
									@if(isset($subcatpro))
									@foreach($subcatpro as $subprodate)
									...
									<div class="col-lg-3 cl-md-4 col-sm-6 col-6 mt-4">
										...
										<div class="homeproducts border">
											<center>
												<a href="{{ route('product_view',$subprodate->id) }}">
													<img src="{{ asset('$subprodate->product_image') }}" class="img-fluid" style="">
												</a>
											</center>
											<div>
												<a href="{{ route('product_view',$subprodate->id) }}">
