...
<main class="main-content">
	...
	<form method="POST" action="{{ route('subcategory_update',$edit->id)}}" enctype="multipart/form-data">
		@csrf
					...
					<div class="card card-shadow mb-4">
						<div class="card-header">
							<div class="card-title">
								...
								<a href="{{ route('manage_subcategory') }}" class="btn py-1 bx-3" style="float:right; font-size:15px; color:#fff; font-weight:400;text-transform: capitalize; background-color:#FE776A; border-radius:1px;"> View Category</a>
							</div>
						</div>
						<div class="card-body">
							...
							<div class="form-group">
								...
								<img  src="{{ asset($edit->subcategory_image) }}" id="profile-img-tag" width="80px" height="80"   style="margin-left:20px; border:1px solid #DFE0E1;">
								@endif
