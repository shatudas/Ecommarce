...
<main class="main-content">
	...
	<form method="POST" action="{{ route('category_update',$edit->id)}}" enctype="multipart/form-data">
		@csrf
					...
					<div class="card-body">
						<form>
							...
							<div class="form-group">
								...
								<img src="{{ asset($edit->category_image)}}" id="profile-img-tag" width="80px" height="80"   style="margin-left:20px; border:1px solid #DFE0E1;">
								@endif
