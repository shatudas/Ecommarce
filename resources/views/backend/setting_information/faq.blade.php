...
<form method="post" action="{{ route('Insert_FAQ')}}" enctype="multipart/form-data">
	@csrf
			...
			<div class=" col-md-12" >
				<div class="card card-shadow mb-4">
					...
					<div class="card-body">
								...
								<input type="text" name="question" class="form-control @error('question') is-invalid @enderror"  aria-describedby="emailHelp" placeholder="Enter question"value="{{old('question')}}">
								 @error('question')
